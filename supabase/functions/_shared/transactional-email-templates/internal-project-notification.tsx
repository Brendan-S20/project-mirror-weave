    ...
    <Body style={main}>
      <Container style={container} className="tn-container">
        <Section style={hero} className="tn-hero">
          <Img src={LOGO_URL} alt={SITE_NAME} width={140} height={38} style={logo} className="tn-logo" />
...
const logo = { display: 'block', margin: '0 0 18px', width: '140px', height: 'auto' as const, maxWidth: '140px' }
const brandMark = { color: ACCENT, fontSize: '10px', letterSpacing: '3px', fontWeight: 700, margin: '0 0 10px', textTransform: 'uppercase' as const }
const h1 = { color: '#ffffff', fontSize: '24px', fontWeight: 700, margin: '0 0 8px', letterSpacing: '-0.01em' }
const lead = { color: '#cbd5e1', fontSize: '14px', margin: 0, lineHeight: 1.5 }
const body = { padding: '28px 32px 8px' }
...
const footer = { color: '#475569', fontSize: '12px', padding: '0 32px 32px', margin: 0, lineHeight: 1.6 }