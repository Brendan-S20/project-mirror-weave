      ...
      <Container style={container} className="tn-container">
        <Section style={hero} className="tn-hero">
          ...
          <Section style={card} className="tn-card">
            ...
            <Text style={item}><span style={dot}>01</span> We review your project scope and goals.</Text>
            <Text style={item}><span style={dot}>02</span> We reply with a tailored response and recommended next steps.</Text>
            <Text style={item}><span style={dot}>03</span> If aligned, we book a 30-minute scoping call.</Text>
          </Section>
...
const brandMark = { color: '#34d399', fontSize: '11px', letterSpacing: '3px', fontWeight: 700, margin: '0 0 12px', textTransform: 'uppercase' as const }
...
const dot = { display: 'inline-block', width: '24px', color: '#059669', fontWeight: 700, marginRight: '12px', fontSize: '12px', letterSpacing: '0.5px' }
