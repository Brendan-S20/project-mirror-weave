...
const reviewData = [
  { rating: 5, title: "Game-changer for our marketing team", text: "The quality and consistency have been incredible. Superside feels like an extension of our team.", author: "VP Marketing, SaaS Company", platform: "G2" },
  ...
  { rating: 5, title: "Best creative partner we've had", text: "After trying agencies and freelancers, Superside is the first solution that actually scaled with our growth.", author: "CMO, E-commerce Brand", platform: "Trustpilot" },
...
export default function Reviews() {
  return (
    <Layout title="Reviews" description="See what 500+ enterprise clients say about working with Superside.">
      <HeroSection
        tagline="Reviews"
        title={<>Don't take our word for it. <span className="heading-italic">Take theirs.</span></>}
        description="See what 500+ enterprise clients say about scaling their creative with Superside."
        variant="centered"
      />
      ...
      <CTASection
        title={<>Join 500+ happy <span className="heading-italic">customers</span></>}
        variant="banner"
      />
    </Layout>
  );
