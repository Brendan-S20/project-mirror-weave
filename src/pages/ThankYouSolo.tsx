...
export default function ThankYouSolo() {
  return (
        ...
        <div className="section-padding py-28 lg:py-44 relative z-10 w-full">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-lg lg:text-xl text-muted-foreground max-w-xl mx-auto mb-6 leading-relaxed animate-fade-up" style={{ animationDelay: '160ms' }}>
              Thanks for reaching out. Whether you're just getting started or exploring what's possible, we're here to help you build the creative foundation your work deserves.
            </p>
            ...
            <div className="flex items-center justify-center gap-4 flex-wrap animate-fade-up" style={{ animationDelay: '240ms' }}>
              <Link to="/design-services" className="btn-lime group">
                View our services
                <ArrowRight className="ml-2 w-4 h-4 transition-transform group-hover:translate-x-1" />
              </Link>
              <Link to="/blog" className="btn-outline-light">Read insights</Link>
            </div>
          </div>
        </div>
