...
export default function ThankYouGrowingTeam() {
  return (
        ...
        <div className="section-padding py-28 lg:py-44 relative z-10 w-full">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-lg lg:text-xl text-muted-foreground max-w-xl mx-auto mb-6 leading-relaxed animate-fade-up" style={{ animationDelay: '160ms' }}>
              Scaling a team means scaling your creative output. The North gives you the speed, consistency, and process structure to keep up with demand without slowing down.
            </p>
