...
export default function StatsSection({ title, stats, variant = "default" }: StatsSectionProps) {
  if (variant === "inline") {
    return (
      <section className="section-padding py-12 border-y border-border/30">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-center gap-12 lg:gap-20">
          {stats.map((s, i) => (
  ...
  return (
    <section className="section-padding py-16 lg:py-24 section-medium">
